...
export const TermsOfUse = () => {
  return (
    <Container text className="custom-container">
      <Helmet>
        <title>{`Terms of Use | Rad X-Rays`}</title>
        <meta
          property="og:image"
      ...
      <p>
        ...
        of Take Rad X-Rays's Website.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions in full. Do not continue to use Take Rad X-Rays's website if
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using Take Rad X-Rays's website you
        consent to the use of cookies in accordance with Take Rad X-Rays’s
        privacy policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, Take Rad X-Rays and/or it’s licensors own the
        intellectual property rights for all material on Take Rad X-Rays. All
        intellectual property rights are reserved. You may view and/or print
        pages from https://www.takeradxrays.com for your own personal use
        subject to restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from https://www.takeradxrays.com</li>
        <li>
          Sell, rent or sub-license material from https://www.takeradxrays.com
        </li>
        <li>
          Reproduce, duplicate or copy material from
          https://www.takeradxrays.com
        </li>
      </ol>
      <p>
        Redistribute content from Take Rad X-Rays (unless content is
      ...
      <ol>
        ...
        <li>
          ...
          areas of the website. Take Rad X-Rays does not screen, edit, publish
          or review Comments prior to their appearance on the website and
          Comments do not reflect the views or opinions ofTake Rad X-Rays, its
          ...
          applicable laws Take Rad X-Raysshall not be responsible or liable for
        ...
        <li>
          Take Rad X-Raysreserves the right to monitor all Comments and to
        ...
        <li>
          You hereby grant to <strong>Take Rad X-Rays</strong> a non-exclusive
      ...
      <p>
        ...
        e-mail to{" "}
        <a
          href="mailto:takeradxrays@gmail.com"
          title="send an email to TakeRadXRays@gmail.com"
        >
      ...
      <p>
        No use of Take Rad X-Rays’s logo or other artwork will be allowed for
